...
<script type="text/javascript">
	$(function() {
		...
		$(".btn-warning").each(function(){
			$(this).click(function() {
				var data = {"type":"3","content":$(this).parent().siblings().eq(0).text()}
	...
	$("#querySupplier").click(function() {
			...
			if($(".content").val()==null||$(".content").val().trim()==""){
				ajaxSubmit("supplier/query?type=3", ".main", "");
				return false;
			}
			...
			case "供应商编号":
				...
				ajaxSubmit("supplier/findById?type=3", ".main", data);
				break;
			case "单位名称":
				ajaxSubmit("supplier/findByName?type=3", ".main", data);
				break;
			case "联系人":
				ajaxSubmit("supplier/findByPeople?type=3", ".main", data);
				break;
			default:
				ajaxSubmit("supplier/query?type=3", ".main", "");
				break;
		...
		$(".pagination li a").each(function() {
			$(this).click(function() {
				...
				ajaxSubmit("supplier/query?type=3", ".main", data);
			});
		});
	});
</script>
